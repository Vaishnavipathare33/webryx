...
from flask import Flask, render_template, request, redirect, flash, jsonify, session, url_for # pyright: ignore[reportMissingImports]
...
from authlib.integrations.flask_client import OAuth # pyright: ignore[reportMissingModuleSource]
